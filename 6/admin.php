...
<?php
    ...
    $value = 1;
    $get_immort_amount = $db->prepare("SELECT count(*) FROM abilities WHERE 1=:value");
    try {
    ...
    $get_wall_amount = $db->prepare("SELECT count(*) FROM abilities WHERE 2=:value");
    try {
    ...
    $get_levit_amount = $db->prepare("SELECT count(*) FROM abilities WHERE 3=:value");
    try {
    ...
    $get_invis_amount = $db->prepare("SELECT count(*) FROM abilities WHERE 4=:value");
    try {
